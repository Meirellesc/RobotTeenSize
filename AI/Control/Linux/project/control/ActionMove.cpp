...
void ActionMove::kick_left_strong(dynamixel::PacketHandler *cm730, bool &stop_gait)
{
    ...
    */
    cm730->write4ByteTxRx(portHandler, 12, 116, uint32_t(MotionManager::GetInstance()->m_Offset[12]+2898), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 14, 116, uint32_t(MotionManager::GetInstance()->m_Offset[14]+1384), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 16, 116, uint32_t(MotionManager::GetInstance()->m_Offset[16]+1953), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 18, 116, uint32_t(MotionManager::GetInstance()->m_Offset[18]+2119), &dxl_error);
...
void ActionMove::kick_right_strong(dynamixel::PacketHandler *cm730, bool &stop_gait)
{
    ...
    */
    ...
    cm730->write4ByteTxRx(portHandler, 11, 116, uint32_t(MotionManager::GetInstance()->m_Offset[11]+1171), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 13, 116, uint32_t(MotionManager::GetInstance()->m_Offset[13]+2320), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 15, 116, uint32_t(MotionManager::GetInstance()->m_Offset[15]+1554), &dxl_error);
    cm730->write4ByteTxRx(portHandler, 17, 116, uint32_t(MotionManager::GetInstance()->m_Offset[17]+1990), &dxl_error);
