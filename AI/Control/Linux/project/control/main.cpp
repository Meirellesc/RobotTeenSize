...
//if(packetHandler->read2ByteTxRx(portHandler, 7, 144, &value, &dxl_error) !=  COMM_SUCCESS)
    ...
    ActionMove actionMove(mem, (char *)MOTION_FILE_PATH, portHandler);
    //**************************************************************************
    ...
    //-------------iniciando o modulo de andar pelo teclado------------------------------------------
        ...
        while(1)
        {
            ...
            switch(key)
            {
                ...
                case 112: //p
                    actionMove.kick_right_strong(packetHandler, stop_gait);
                break;

                case 108: //l
                    actionMove.kick_left_strong(packetHandler, stop_gait);
                break;
                ...
                case 105: //i
                    actionMove.pass_left(packetHandler, stop_gait);
                break;
                ...
                case 106: //j
                    actionMove.pass_right(packetHandler, stop_gait);
                break;
